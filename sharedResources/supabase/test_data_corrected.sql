-- Wopital Test Data - Corrected Schema Version
...
-- Create lab results (corrected schema)
INSERT INTO lab_results (id, patient_id, test_name, test_date, result_value, normal_range, unit, status, notes, ordered_by) VALUES
('gg0e8400-e29b-41d4-a716-446655440001', '770e8400-e29b-41d4-a716-446655440001', 'Blood Glucose', '2024-07-15', '95', '70-100', 'mg/dL', 'normal', 'Fasting blood glucose test', '880e8400-e29b-41d4-a716-446655440001'),
('gg0e8400-e29b-41d4-a716-446655440002', '770e8400-e29b-41d4-a716-446655440002', 'HbA1c', '2024-07-16', '6.2', '4.0-5.6', '%', 'elevated', 'Diabetes monitoring', '880e8400-e29b-41d4-a716-446655440002'),
('gg0e8400-e29b-41d4-a716-446655440003', '770e8400-e29b-41d4-a716-446655440003', 'Complete Blood Count', '2024-07-17', '12.5', '11.0-15.5', 'g/dL', 'normal', 'Routine health check', '880e8400-e29b-41d4-a716-446655440003'),
('gg0e8400-e29b-41d4-a716-446655440004', '770e8400-e29b-41d4-a716-446655440004', 'Cholesterol Panel', '2024-07-18', '180', '0-200', 'mg/dL', 'normal', 'Cardiovascular risk assessment', '880e8400-e29b-41d4-a716-446655440004'),
('gg0e8400-e29b-41d4-a716-446655440005', '770e8400-e29b-41d4-a716-446655440005', 'Liver Function Test', '2024-07-19', '25', '7-56', 'U/L', 'normal', 'Medication monitoring', '880e8400-e29b-41d4-a716-446655440005')
ON CONFLICT (id) DO NOTHING;

-- Create medical records (corrected schema)
